...
<body>
    ...
    <nav class="navbar">
        ...
        <img src="1.png" alt="Bombakar Logo" class="logo-img">
...
<main>
    ...
    <section class="operations" id="fire-services">
        ...
        <div class="card">
            <img src="operation1.jpg" alt="Fire Suppression">
            <h3>Fire Suppression</h3>
        </div>
        <div class="card">
            <img src="operation2.jpg" alt="Emergency Medical">
            <h3>Emergency Medical Services</h3>
        </div>
        <div class="card">
            <img src="operation3.jpg" alt="Technical Rescue">
            <h3>Technical Rescue Services</h3>
        </div>
        <div class="card">
            <img src="operation4.jpg" alt="Fire Prevention">
